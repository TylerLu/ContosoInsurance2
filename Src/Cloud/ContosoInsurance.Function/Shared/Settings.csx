...
public static class Settings
{
    ...
    public static readonly string NotificationHubName = settings["MS_NotificationHubName"];
    public static readonly string NotificationHubConnection = settings["MS_NotificationHubConnectionString"];
}